...
On May 14th, I launched [Oh Bother](ohbother.app) — my first independent app in 7 years. I wrote a bit about my decision to build Oh Bother [here](danielgauthier.me/left-turn), but now that my little app is actually out in the world, trying to make a name for itself, I thought it’d be fun to reflect on the whole process and on what comes next. Here we go!
...
### April 11
Finished building all the fun little interactions in the status update drawer — the wobbly buttons, the modal inputs, the status change animations. Was definitely [following my own advice](danielgauthier.me/2020/02/11/indie-3.html) by getting this nice and polished early on 🤓 Pretty close to the final look and feel at this point.
...
In my [article about imposter syndrome](danielgauthier.me/imposter-syndrome) earlier this year, I wrote the following:
