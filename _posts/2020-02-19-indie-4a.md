---
layout: post
title: "Going indie, step 4a: Wrap your head around custom view controller transitions"
twitter_subtitle: "A quick primer on how this wacky API actually works"
twitter_image: assets/img/indie-4a.png
...
![Overwhelmed by view controller transition diagram](/assets/img/indie-4a.png)
...
>
> **HomeViewController**  
> Oh right, here’s a `FancyWarningAnimationController` you can use. I’ve made sure it’s set to present rather than dismiss.
>
> **UIKit**  
...
a) think this whole thing seems wildly overcomplicated, and  
